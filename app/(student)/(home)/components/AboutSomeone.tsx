...
const AboutSomeone = () => {
    return (
        <section>
            <h1 className="text-center text-[#401A0C] font-semibold text-xl md:text-3xl mt-5 mb-[35px] lg:mb-[77px]">ABOUT OC <br
                className="md:hidden"/> OMOFUMA</h1>
            <div className="overflow-x-hidden lg:flex lg:justify-center lg:flex-col lg:items-center">
                <p className="whitespace-nowrap w-screen font-semibold text-base md:text-2xl animate-marquee lg:animate-none mb-[37px] lg:mb-[87px] italic">I am
                    a <span className="text-[#E89222]">  teacher </span>| guitarist | songwriter | artist | family man.
                </p>
                <p className="font-normal text-xs md:text-base text-end lg:text-center animate-marquee lg:animate-none pl-[50px] w-[660px]">I started Spicy Guitar Academy in 2016 -
                ...
                <section className="flex gap-[110px] animate-marquee lg:animate-none mt-[100px] lg:mt-[82px]">
