...
const FreeCourse = () => {
    return (
        <section className="w-screen pt-9 pl-[19px] pr-[19px] lg:pl-[59px] lg:pr-[49px] font-poppins">
            <h1 className="font-bold text-[40px] text-[#602712] font-poppins mb-5">Free Courses</h1>
            <div className="rounded-lg lg:rounded-2xl h-[206px] lg:h-[283px] bg-cover bg-e mb-[115px] lg:mb-9"/>
            <section className="w-full flex flex-wrap gap-5 mb-5">
                {
                    courses.map((course) => (
                        <Link key={course.id} href={`/free-course/${course.id}`}>
                            <div
                                className="w-[229px] lg:w-[300px] h-[268px] lg:h-[276px] py-4 px-2 text-center shadow-custom bg-[#A8533408] cursor-pointer">
                                ...
                                <div className="flex justify-between">
                                    <div className="flex gap-1.5 px-1.5 py-1 rounded-lg w-fit text-[#602712]">
                                        ...
                                        <span className="text-sm font-medium whitespace-nowrap">{course.lessonsCount}</span>
                                    </div>
                                    <div className="flex gap-1.5 px-2.5 py-1 rounded-lg bg-[#602712] w-fit">
                                        <span className="text-sm font-normal text-white whitespace-nowrap">FREE</span>
                                    </div>
                                </div>
                            </div>
                        </Link>
