...
const Subscription = () => {
    return (
        <section className="px-5 md">
            ...
            <div className="flex flex-col md:flex-row flex-wrap gap-3.5 py-5 border md:border-0 border-[#602712] rounded-lg items-center justify-center md:justify-start mb-12">
                {
                    subscriptionPlans.map((subscriptionPlan, index) => (
                        ...
                        >
                            <p className="bg-[#D1831F] px-[10px] py-[6px] rounded-tl-md rounded-br-md text-white font-semibold text-xs absolute top-0 right-0">
                                {subscriptionPlan.discount}%
                                OFF
                            </p>
                            <p className="mt-7 font-medium text-[#895543]">{subscriptionPlan.duration} PLAN</p>
